...
const path = require('path'); // 1. IMPORTA O MÓDULO 'path'
...
// (Login, casais, meus-dados, convidados, etc.)
...
// Ela garante que qualquer pedido que não seja para a API, sirva o site público.
app.get('*', (req, res) => {
